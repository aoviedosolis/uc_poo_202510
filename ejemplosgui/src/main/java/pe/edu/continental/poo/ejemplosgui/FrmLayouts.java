...
public class FrmLayouts extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().setLayout(new java.awt.GridLayout(4, 4, 10, 10));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmLayouts.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
